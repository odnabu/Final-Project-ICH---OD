...
from find_film_by_keyword import find_film_by_keyword
from additional import get_query_type, ask_film_keyword
from find_film_by_genre_year import (get_list_categories,
                                     find_film_by_genre
                                     , get_max_min_year
                                     , find_film_by_genre_year
                                     , choose_category )
from get_popular_search_query import get_popular_search_query
# +++++++++++++++++++++++++++++++++++++++++++++++
...
def main_menu():
    ...
    while True:
        ...
        print(f'\nTo search for films, select the NUMBER one of the menu items:')
        print(f'\033[40;33m{'∷∷∷   MENU   ':∷<{l}}\033[m')

        print(f'\033[0;33m   ∷ 1\033[m\033[0;38m{' Search by keyword': <{l-4}}\033[m')
        ...
        print(f'\033[0;33m   ∷ 5\033[m\033[0;38m{' EXIT': <{l-4}}\033[m')

        ask = input(f'Enter the \033[40;33m{'NUMBER'}\033[m of the menu items: ')
        ...
        if ask == '1':
            ...
            print(f'\nTo find for films, select the NUMBER of GENRE:')
            get_list_categories(cursor_read)
            category_name = choose_category(cursor_read)
            print(f'\nThen chose the year from next range:')
